...
class General(object):
    ...
    # =================================================================
    # ===== Obtener documentos desde databases =====
    # =================================================================

    def get_file_base_csv(self, name):
        if not name.endswith(".csv"):
            name += ".csv"
        tempFolder = os.path.join(self.main_path, 'databases')
        _base      = os.path.join(tempFolder, name)
        return _base
    
    def get_file_base_json(self, name):
        if not name.endswith(".json"):
            name += ".json"
        tempFolder = os.path.join(self.main_path, 'edits')
        _base      = os.path.join(tempFolder, name)
    ...
    def get_file_base_db(self, name):
    ...
    def get_file_base_xlsx(self, name):
    ...
    # =================================================================
    # ===== Fin de obtención de documentos desde databases =====
    # =================================================================
